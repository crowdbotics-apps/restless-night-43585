"""
Django settings for restless_night_43585 project.
...
ROOT_URLCONF = 'restless_night_43585.urls'
...
WSGI_APPLICATION = 'restless_night_43585.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_night_43585 API",
    "DESCRIPTION": "API documentation for restless_night_43585 App",
    "VERSION": "v1",
}
